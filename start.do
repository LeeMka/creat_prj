...
#指定仿真顶层
	#不涉及IP库
	vsim -t 1ps -L rtl_work -L work -novopt rtl_work.iic_master_tb
	#涉及IP库
	#vsim -t 1ps -L altera_mf_ver -L rtl_work -L work -L verilog_libs -novopt rtl_work.iic_master_tb
#添加信号到波形窗 							  
#add wave -position insertpoint sim:/tb_iic_master//*
do wave.do
run -all 